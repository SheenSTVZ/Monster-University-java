...
public class PecanCantonPK implements Serializable {
    ...
    public PecanCantonPK(String pepaisCodigo, String peprovCodigo, String pecanCodigo) {
    ...
    public String toString() {
        return "ec.edu.monster.model.PecanCantonPK[ pepaisCodigo=" + pepaisCodigo + ", peprovCodigo=" + peprovCodigo + ", pecanCodigo=" + pecanCodigo + " ]";
    }
