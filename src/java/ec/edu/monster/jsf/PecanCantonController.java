...
import ec.edu.monster.jpaController.PecanCantonFacade;
...
public class PecanCantonController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.jpaController.PecanCantonFacade ejbFacade;
    ...
    protected void setEmbeddableKeys() {
        selected.getPecanCantonPK().setPepaisCodigo(selected.getPeprovProvin().getPeprovProvinPK().getPepaisCodigo());
        selected.getPecanCantonPK().setPeprovCodigo(selected.getPeprovProvin().getPeprovProvinPK().getPeprovCodigo());
    }

    protected void initializeEmbeddableKey() {
        selected.setPecanCantonPK(new ec.edu.monster.model.PecanCantonPK());
    }
    ...
    public PecanCanton getPecanCanton(ec.edu.monster.model.PecanCantonPK id) {
    ...
    public static class PecanCantonControllerConverter implements Converter {
        ...
        ec.edu.monster.model.PecanCantonPK getKey(String value) {
            ec.edu.monster.model.PecanCantonPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new ec.edu.monster.model.PecanCantonPK();
        ...
        String getStringKey(ec.edu.monster.model.PecanCantonPK value) {
